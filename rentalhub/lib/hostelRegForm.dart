  ...
  Future<void> _submitForm() async {
    ...
    for (String roomType in _roomTypes) {
      if (_selectedRoomTypes[roomType] == true &&
          _roomTypePrices[roomType]!.text.isEmpty) {
        showDialog(
          context: context,
          builder: (context) => AlertDialog(
            title: const Text('Form Submission Failed'),
    ...
    try {
      ...
      if (_profileImage != null) {
        ...
        Reference ref =
            storage.child('profile_images/$userId/$profileImageName');
      ...
      _roomTypes.forEach((roomType) {
        if (_selectedRoomTypes[roomType] == true) {
          roomTypePrices[roomType] =
              double.parse(_roomTypePrices[roomType]!.text);
        }
      });
      ...
      final hostelRef = await FirebaseFirestore.instance
          .collection('hostels')
          .add(hostelData);
        ...
        child: Form(
          child: Column(
            ...
            children: [
              ...
              _buildTextInput(_numberOfRoomsController, 'Number of Rooms',
                  Icons.meeting_room,
             ...
             _buildTextInput(
              ...
              const SizedBox(height: 16.0),
              _buildTextInput(
                  _managerNameController, 'Manager Name', Icons.person),
